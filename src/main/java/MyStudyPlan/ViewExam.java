    ...
    public ViewExam(ExamInstance examInstance) {
        ...
        for (int i = 0; i < SubjectComboBox.getItemCount(); i++) {
            if (SubjectComboBox.getItemAt(i)
                    .equals(examInstance.getSubject().getCode() + " " + examInstance.getSubject().getName())) {
                SubjectComboBox.setSelectedIndex(i);
                break;
            }
        }
        DatePicker
                .setDate(java.util.Date.from(examInstance.getDate().atStartOfDay(ZoneId.systemDefault()).toInstant()));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                                        .addComponent(DatePicker, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(BuildingRoomTxtField, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(SeatTxtField, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
